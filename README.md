# Wait Wait Don't Tell Me! Playing Card Gallery

## Overview

Flask-based web application that serves up an image gallery for packs of the [Wait Wait Don't Tell Me!](https://waitwait.npr.org/) playing cards that were handed out as prizes or gifts.
...
This web application is distributed under the terms of the [Apache License 2.0](./LICENSE-APACHE).
