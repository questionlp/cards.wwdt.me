...
The application code for this project is distributed under version 2.0 of the Apache License. A copy of the license is available in this repository at [LICENSE](./LICENSE-APACHE).
